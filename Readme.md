# E-Commerce Portal (FastAPI + React)

This repository contains a simple end-to-end e-commerce portal with:

- **Backend:** Python **FastAPI** (APIs for products, cart, orders, auth, etc.)
